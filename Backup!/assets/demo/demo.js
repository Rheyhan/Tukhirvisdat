...
demo = {
  ...
  initDashboardPageCharts: function() {
    ...
    var chart_data = [364.7380952, 381.3761111, 397.42, 408.4538889, 403.176, 399.3857143, 396.481, 408.035, 412.1608, 427.4278, 425.3647, 402.2478];
    ...
    $("#1").click(function() {
      var chart_data = [419.329, 397.8815789, 392.7277273, 366.3490476, 349.7935294, 347.1628571, 330.9428571, 333.466, 336.2704545, 376.6595, 379.9245455, 370.8363158];
      var data = myChartData.config.data;
      data.datasets[0].data = chart_data;
      data.labels = chart_labels;
      myChartData.update();
    ...
    var myChart = new Chart(ctx, {
      ...
      data: {
        labels: ['Perbankan', 'Pertambangan', 'Properti', 'Industri Kimia', 'Infrastruktur'],
        datasets: [{
          label: "categories",
          fill: true,
          backgroundColor: gradientStroke,
          ...
          borderDash: [],
          borderDashOffset: 0.0,
          data: [7.28, 3.59, -30.49, -12.59, 1.43],
        }]
      },
